...
//       <LoginCard>
//         <LogoContainer>
//           <Logo src = "../../components/assets/images/logo.png" alt="마켓봇 로고" />
...
//         <SignupPrompt>
//           계정이 없으신가요? <SignupLink to="/auth/signup">회원가입</SignupLink>
//         </SignupPrompt>
//       </LoginCard>
//     </LoginContainer>
//   );
...
const LoginPage = () => {
  ...
  // Pre-populate email and password values (if needed)
  const [formData, setFormData] = useState({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validate()) {
      // Simulate a login by saving a dummy token in localStorage.
